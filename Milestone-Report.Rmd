...
```{r, eval=FALSE}
set.seed(1234567)
subTwitter <- sample(twitterText, size = 30000, replace = TRUE)
subBlogs <- sample(blogsText, size = 30000, replace = TRUE)
subNews <- sample(newsText, size = 30000, replace = TRUE)
sampleTotal <- c(subTwitter, subBlogs, subNews)
length(sampleTotal)
writeLines(sampleTotal, "./sampleTotal.txt")
```
Each file contributes 30,000 lines of text compile a new text file called sampleTotal.txt which has a total of 90,000 lines.
